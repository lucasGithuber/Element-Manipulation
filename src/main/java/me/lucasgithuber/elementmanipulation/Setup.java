...
import me.lucasgithuber.elementmanipulation.elements.transitionmetals.*;
import me.lucasgithuber.elementmanipulation.machines.*;
...
public class Setup {
    ...
    public static void setup(ElementManipulation p) {
        ...
        new EMSilver(Categories.EMElements).register(p);
        new EMAu(Categories.EMElements).register(p);
        // machines
